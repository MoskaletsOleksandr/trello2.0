...
`,ct=l.div``,ut=({columnId:r,onClose:t,columnTitle:e})=>{const n=A(),a=o=>{const s={title:o.title};n(qe({columnId:r,body:s})),t()};return i.jsx(te,{onClose:t,title:"Edit column",children:i.jsx(ne,{initialValues:{title:e},validationSchema:ae({title:_().max(15,"Must be 15 characters or less").required("Name is required")}),onSubmit:a,children:i.jsxs(oe,{children:[i.jsx(ie,{type:"text",name:"title",placeholder:"Title"}),i.jsx(E,{name:"title"}),i.jsx(re,{type:"submit",children:"Edit"})]})})})},ht=l.div`
  position: relative;
  cursor: grab;
  display: flex;
  flex-direction: column;
...
`,Xr=({boardId:r,onClose:t})=>{const e=A(),n=a=>{const o={title:a.title,boardId:r};e(Re(o)),t()};return i.jsx(te,{onClose:t,title:"Add column",children:i.jsx(ne,{initialValues:{title:""},validationSchema:ae({title:_().max(15,"Must be 15 characters or less").required("Name is required")}),onSubmit:n,children:i.jsxs(oe,{children:[i.jsx(ie,{type:"text",name:"title",placeholder:"Title"}),i.jsx(E,{name:"title"}),i.jsx(re,{type:"submit",children:"Add"})]})})})},Gr=()=>{const[r,t]=w.useState(!1),e=L(ke),n=()=>{t(!0)},a=()=>{t(!1)};return i.jsxs(i.Fragment,{children:[i.jsxs(Ar,{onClick:n,type:"button",children:[i.jsx(zr,{children:i.jsx(Qr,{width:"28px",height:"28px",children:i.jsx("use",{href:q+"#icon-plus"})})}),"Add another column"]}),r&&i.jsx(Xr,{boardId:e,onClose:a})]})},Vr=l.button`
  display: flex;
  gap: 8px;
  justify-content: center;
  align-items: center;
