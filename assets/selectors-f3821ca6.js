...
`,M=({children:e,onClick:r,type:s})=>o.jsxs(q,{onClick:r,type:s,children:[o.jsx(D,{children:o.jsx(F,{width:"28px",height:"28px",children:o.jsx("use",{href:g+"#icon-plus"})})}),e]});M.propTypes={children:i.oneOfType([i.string,i.object]).isRequired,onClick:i.func,type:i.string};const H=e=>e.boards.boards,J=e=>e.boards.currentBoard,K=e=>e.boards.currentBoard.background,Y=e=>e.boards.currentBoard.title,Q=e=>e.boards.backgrounds;export{M as B,A as C,$ as M,J as a,H as b,Y as c,K as d,U as i,G as p,Q as s,V as t};
