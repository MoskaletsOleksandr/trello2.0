import{n as s,N as v,r as d,j as e,u,l as y,b as k,c as S,d as E,s as q,e as F,f as P,g as I}from"./index-d97a85be.js";import{F as z,a as L,E as M,b as h,c as x,d as i}from"./index.esm-9ac69e75.js";import{s as $}from"./sprite-fc6f0751.js";import{G as b}from"./GoogleButton-80a92dff.js";import{_ as A,I as p}from"./index-e42ea881.js";const f=s(z)`
  display: flex;
...
`,D=()=>{const o=u(),{id:t}=S(),r=E(q);if(d.useEffect(()=>{r&&A.error(r)},[r]),d.useEffect(()=>{o(F()),o(P()),o(I())},[]),t==="register")return e.jsxs(m,{children:[e.jsx(T,{}),e.jsx(p,{position:"top-right",reverseOrder:!1})]});if(t==="login")return e.jsxs(m,{children:[e.jsx(N,{}),e.jsx(p,{position:"top-right",reverseOrder:!1})]})};export{D as default};
