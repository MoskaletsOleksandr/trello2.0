import{n as l,u as A,j as i,A as qe,r as w,B as Fe,_ as Te,a as L,C as Be,D as fe,E as Oe,F as Ne,H as je,I as Re,v as ke,J as He}from"./index-96c59242.js";import{M as te,S as re,a as ne,b as _,B as ae,p as De,f as Me,g as K,h as Se,C as pe,j as Ae,k as Qe}from"./selectors-b091a180.js";import{s as q}from"./sprite-cc172135.js";import{b as oe,c as ie,d as E,a as ze,u as Xe}from"./index.esm-3bdc5a4a.js";const Ge=l.div`
  display: flex;
...
`,ct=l.div``,ut=({columnId:r,onClose:t,columnTitle:e})=>{const n=A(),a=o=>{const s={title:o.title};n(qe({columnId:r,body:s})),t()};return i.jsx(te,{onClose:t,title:"Edit column",children:i.jsx(oe,{initialValues:{title:e},validationSchema:ie({title:E().max(20,"Must be 20 characters or less").required("Name is required")}),onSubmit:a,children:i.jsxs(re,{children:[i.jsx(ne,{type:"text",name:"title",placeholder:"Title"}),i.jsx(_,{name:"title"}),i.jsx(ae,{type:"submit",children:"Edit"})]})})})},ht=l.div`
  position: relative;
  cursor: grab;
  display: flex;
  flex-direction: column;
...
`,Xr=({boardId:r,onClose:t})=>{const e=A(),n=a=>{const o={title:a.title,boardId:r};e(Re(o)),t()};return i.jsx(te,{onClose:t,title:"Add column",children:i.jsx(oe,{initialValues:{title:""},validationSchema:ie({title:E().max(20,"Must be 20 characters or less").required("Name is required")}),onSubmit:n,children:i.jsxs(re,{children:[i.jsx(ne,{type:"text",name:"title",placeholder:"Title"}),i.jsx(_,{name:"title"}),i.jsx(ae,{type:"submit",children:"Add"})]})})})},Gr=()=>{const[r,t]=w.useState(!1),e=L(ke),n=()=>{t(!0)},a=()=>{t(!1)};return i.jsxs(i.Fragment,{children:[i.jsxs(Ar,{onClick:n,type:"button",children:[i.jsx(Qr,{children:i.jsx(zr,{width:"28px",height:"28px",children:i.jsx("use",{href:q+"#icon-plus"})})}),"Add another column"]}),r&&i.jsx(Xr,{boardId:e,onClose:a})]})},Vr=l.button`
  display: flex;
  gap: 8px;
  justify-content: center;
  align-items: center;
