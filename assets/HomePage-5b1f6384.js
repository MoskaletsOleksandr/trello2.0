import{b as h,s as X,c as d,u as f,j as e,d as G,e as J,f as K,g as T,h as M,i as Q,k as Y,m as Z,n as ee,o as te,O as oe}from"./index-cda7ef00.js";import{n as t}from"./emotion-styled.browser.esm-69db5252.js";import{s as x}from"./sprite-33c0d800.js";import{C as se,t as ne,i as re,s as ie,M as L,S as O,a as q,b as g,B as j,c as z,d as v,e as ce}from"./Button-937f9e99.js";import{a as F,u as _,b as E,c as R,d as m}from"./index.esm-a174d4ee.js";import{L as ae}from"./Logo-8e7fca2b.js";const le=t.header`
  display: flex;
  flex-grow: 1;
  height: 68px;
  align-items: center;
...
`,$e=()=>{const[o,n]=d.useState(!1),s=()=>{n(!0)},r=()=>{n(!1)};return e.jsxs(e.Fragment,{children:[e.jsxs(Be,{children:[e.jsx(Ie,{children:"Create a new board"}),e.jsx(Ce,{type:"button",onClick:s,children:e.jsx(Se,{width:"20px",height:"20px",children:e.jsx("use",{href:x+"#icon-plus"})})})]}),o&&e.jsx(N,{onClose:r})]})},Te=({boardId:o,onClose:n})=>{var c,i;const s=h(v),r=f(),l=p=>{const b={title:p.title,icon:p.selectedIcon,backgroundId:p.selectedBg};r(K({boardId:o,body:b})),n()};return e.jsx(L,{onClose:n,title:"Edit board",children:e.jsx(E,{initialValues:{title:s==null?void 0:s.title,selectedIcon:s==null?void 0:s.icon,selectedBg:(c=s==null?void 0:s.background)==null?void 0:c._id},validationSchema:R({title:m().max(15,"Must be 15 characters or less").required("Name is required"),selectedIcon:m().required("Icon is required"),selectedBg:m().required("Background is required")}),onSubmit:l,children:e.jsxs(O,{children:[e.jsx(q,{type:"text",name:"title",placeholder:"Title"}),e.jsx(g,{name:"title"}),e.jsx(j,{children:"Icons"}),e.jsx(A,{name:"selectedIcon",selectedItem:s==null?void 0:s.icon}),e.jsx(g,{name:"selectedIcon"}),e.jsx(j,{children:"Backgrounds"}),e.jsx(H,{name:"selectedBg",selectedItem:(i=s==null?void 0:s.background)==null?void 0:i._id}),e.jsx(g,{name:"selectedBg"}),e.jsx(z,{type:"submit",children:"Edit"})]})})})},Me=t.ul`
  width: 100%;
  min-height: 61px;
  margin-bottom: 40px;
