import{n as l,u as A,j as i,y as Le,r as w,z as Fe,_ as Te,a as q,A as Be,B as fe,C as Oe,D as Ne,E as je,F as Re,q as ke,H as He}from"./index-63d439de.js";import{M as te,S as re,a as ne,b as _,B as ae,p as De,f as Me,g as K,h as Se,C as pe,j as Ae,k as ze}from"./selectors-d085f2f5.js";import{s as L}from"./sprite-33c0d800.js";import{b as oe,c as ie,d as E,a as Qe,u as Xe}from"./index.esm-725effa0.js";const Ge=l.div`
  display: flex;
...
`,ct=l.div``,ut=({columnId:r,onClose:t,columnTitle:e})=>{const n=A(),a=o=>{const s={title:o.title};n(Le({columnId:r,body:s})),t()};return i.jsx(te,{onClose:t,title:"Edit column",children:i.jsx(oe,{initialValues:{title:e},validationSchema:ie({title:E().max(15,"Must be 15 characters or less").required("Name is required")}),onSubmit:a,children:i.jsxs(re,{children:[i.jsx(ne,{type:"text",name:"title",placeholder:"Title"}),i.jsx(_,{name:"title"}),i.jsx(ae,{type:"submit",children:"Edit"})]})})})},ht=l.div`
  position: relative;
  cursor: grab;
  display: flex;
  flex-direction: column;
...
`,Xr=({boardId:r,onClose:t})=>{const e=A(),n=a=>{const o={title:a.title,boardId:r};e(Re(o)),t()};return i.jsx(te,{onClose:t,title:"Add column",children:i.jsx(oe,{initialValues:{title:""},validationSchema:ie({title:E().max(15,"Must be 15 characters or less").required("Name is required")}),onSubmit:n,children:i.jsxs(re,{children:[i.jsx(ne,{type:"text",name:"title",placeholder:"Title"}),i.jsx(_,{name:"title"}),i.jsx(ae,{type:"submit",children:"Add"})]})})})},Gr=()=>{const[r,t]=w.useState(!1),e=q(ke),n=()=>{t(!0)},a=()=>{t(!1)};return i.jsxs(i.Fragment,{children:[i.jsxs(Ar,{onClick:n,type:"button",children:[i.jsx(zr,{children:i.jsx(Qr,{width:"28px",height:"28px",children:i.jsx("use",{href:L+"#icon-plus"})})}),"Add another column"]}),r&&i.jsx(Xr,{boardId:e,onClose:a})]})},Vr=l.button`
  display: flex;
  gap: 8px;
  justify-content: center;
  align-items: center;
