import{n as t,j as e,r as c,u as j,d as X,a as m,e as G,f as J,g as K,h as Q,i as Y,k as _,m as U,o as Z,p as ee,q as te,t as oe,v as se,O as re,x as ne}from"./index-15bcd516.js";import{s as x}from"./sprite-33c0d800.js";import{M as y,S as I,a as v,b as f,B,C as ie,t as ae,i as le,s as ce,c as w,d as C,e as de}from"./selectors-4bfb13d7.js";import{b as $,c as S,d as b,a as z,u as N}from"./index.esm-318df646.js";import{L as pe}from"./Logo-a20efc51.js";import{s as xe,a as he,_ as ue,I as ge}from"./selectors-341fd1eb.js";const me=t.header`
  display: flex;
  flex-grow: 1;
  height: 60px;
  align-items: center;
...
`,De=t.svg`
  ...
  fill: transparent;
  cursor: pointer;
`,R=({name:o,selectedItem:s})=>{const[r,n]=c.useState(s||""),{setFieldValue:l}=N();return c.useEffect(()=>{n(s||"")},[s]),e.jsx(Ue,{children:le.map(a=>e.jsx(ze,{children:e.jsxs(Ne,{children:[e.jsx(Re,{type:"radio",name:o,value:a,onChange:i=>{n(i.target.value),l(o,i.target.value)}}),e.jsx(De,{selected:r===a,children:e.jsx("use",{href:x+`#${a}`})})]})},a))})},He=t.ul`
  display: flex;
  flex-wrap: wrap;
  gap: 4px;
  width: 252px;
...
`,Ke=()=>{const[o,s]=c.useState(!1),r=()=>{s(!0)},n=()=>{s(!1)};return e.jsxs(e.Fragment,{children:[e.jsxs(We,{children:[e.jsx(Xe,{children:"Create a new board"}),e.jsx(Ge,{type:"button",onClick:r,children:e.jsx(Je,{width:"20px",height:"20px",children:e.jsx("use",{href:x+"#icon-plus"})})})]}),o&&e.jsx(H,{onClose:n})]})},Qe=({boardId:o,onClose:s})=>{var a,i;const r=m(C),n=j(),l=p=>{const g={title:p.title,icon:p.selectedIcon,backgroundId:p.selectedBg};n(Y({boardId:o,body:g})),s()};return e.jsx(y,{onClose:s,title:"Edit board",children:e.jsx($,{initialValues:{title:r==null?void 0:r.title,selectedIcon:r==null?void 0:r.icon,selectedBg:((a=r==null?void 0:r.background)==null?void 0:a._id)||"null"},validationSchema:S({title:b().max(15,"Must be 15 characters or less").required("Name is required"),selectedIcon:b().required("Icon is required"),selectedBg:b().required("Background is required")}),onSubmit:l,children:e.jsxs(I,{children:[e.jsx(v,{type:"text",name:"title",placeholder:"Title"}),e.jsx(f,{name:"title"}),e.jsx(w,{children:"Icons"}),e.jsx(R,{name:"selectedIcon",selectedItem:r==null?void 0:r.icon}),e.jsx(f,{name:"selectedIcon"}),e.jsx(w,{children:"Backgrounds"}),e.jsx(D,{name:"selectedBg",selectedItem:((i=r==null?void 0:r.background)==null?void 0:i._id)||"null"}),e.jsx(f,{name:"selectedBg"}),e.jsx(B,{type:"submit",children:"Edit"})]})})})},Ye=t.ul`
  width: 100%;
  min-height: 61px;
  margin-bottom: 40px;
