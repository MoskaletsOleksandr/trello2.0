import{n as t,j as e,r as c,u as j,d as X,a as m,e as G,f as J,g as K,h as Q,i as Y,k as _,m as z,o as Z,p as ee,q as te,t as oe,v as se,O as re,x as ne}from"./index-e95cb96f.js";import{s as x}from"./sprite-685f0d05.js";import{M as y,B as I,C as ie,t as ae,i as le,s as ce,a as B,b as de}from"./selectors-47a17955.js";import{b as C,c as $,d as f,e as S,S as v,f as b,a as U,u as N,B as w}from"./ModalComponents.styled-f102713d.js";import{L as pe}from"./Logo-ea922d0a.js";import{s as xe,a as he,_ as ue,I as ge}from"./selectors-cab4e13d.js";const me=t.header`
  display: flex;
  flex-grow: 1;
  height: 60px;
  align-items: center;
...
`,Ee=t.svg`
  ...
  width: 10px;
  height: 10px;
`,qe=({avatarUrl:o,onAvatarChange:s})=>e.jsxs(Se,{children:[o?e.jsx(Le,{src:o}):e.jsx(Me,{children:e.jsx("use",{href:`${x}#icon-avatar`})}),e.jsxs(Te,{children:[e.jsx(Oe,{type:"file",accept:"image/*",onChange:s}),e.jsx(Ee,{children:e.jsx("use",{href:`${x}#icon-plus`})})]})]}),Fe=({onClose:o,user:s})=>{const[r,n]=c.useState(s.avatarUrl),[l,a]=c.useState(null),i=j(),p=h=>{const g=h.target.files[0];if(g){const k=URL.createObjectURL(g);n(k),a(g)}},u=h=>{const g=new FormData;g.append("newName",h.name),g.append("newEmail",h.email),g.append("avatar",l),i(X(g)),o()};return e.jsx(y,{onClose:o,title:"Edit profile",children:e.jsx(C,{initialValues:{name:s.name,email:s.email,avatarUrl:s.avatarUrl},validationSchema:$({name:f().max(15,"Must be 15 characters or less").required("Name is required"),email:f().email("Invalid email address").required("Email is required")}),onSubmit:u,children:e.jsxs(S,{children:[e.jsx(qe,{avatarUrl:r,onAvatarChange:p}),e.jsx(v,{type:"text",name:"name",placeholder:"Name",profile:"true"}),e.jsx(b,{name:"name"}),e.jsx(v,{type:"email",name:"email",placeholder:"Email",profile:"true"}),e.jsx(b,{name:"email"}),e.jsx(I,{type:"submit",children:"Edit"})]})})})},Ae=()=>{const o=m(G),[s,r]=c.useState(!1),{name:n,avatarUrl:l}=o,a=()=>{r(!0)},i=()=>{r(!1)};return e.jsxs(ke,{children:[e.jsx(ye,{children:e.jsx($e,{children:n})}),e.jsx(Ie,{onClick:a,children:l?e.jsx(Ce,{src:l}):e.jsx(Be,{children:e.jsx("use",{href:`${x}#icon-avatar`})})}),s&&e.jsx(Fe,{onClose:i,user:o})]})},_e=({toggleSidebar:o})=>{const s=m(J),[r,n]=c.useState(!1),l=c.useRef(null),a=j();c.useEffect(()=>{document.body.classList.remove("light","dark","violet"),document.body.classList.add(s)},[s]);const i=()=>{n(!r)},p=h=>{h.stopPropagation(),i()},u=h=>{h!==s&&(a(K({theme:h})),i())};return e.jsxs(me,{children:[e.jsx(fe,{onClick:()=>{o()},children:e.jsx(be,{children:e.jsx("use",{href:`${x}#icon-menu`})})}),e.jsxs(je,{children:[e.jsxs(ve,{ref:l,onClick:p,children:["Theme",e.jsx(we,{children:e.jsx("use",{href:`${x}#icon-chevron-down`})})]}),e.jsx(Ae,{}),r&&e.jsx(ie,{title:"Select theme",options:ae,selectedOption:s,isOpen:r,onClose:i,handleOptionClick:u,openBtnRef:l})]})]})},ze=t.ul`
  display: flex;
  gap: 8px;
`,Ue=t.li`
  display: block;
...
`,Ke=()=>{const[o,s]=c.useState(!1),r=()=>{s(!0)},n=()=>{s(!1)};return e.jsxs(e.Fragment,{children:[e.jsxs(We,{children:[e.jsx(Xe,{children:"Create a new board"}),e.jsx(Ge,{type:"button",onClick:r,children:e.jsx(Je,{width:"20px",height:"20px",children:e.jsx("use",{href:x+"#icon-plus"})})})]}),o&&e.jsx(H,{onClose:n})]})},Qe=({boardId:o,onClose:s})=>{var a,i;const r=m(B),n=j(),l=p=>{const u={title:p.title,icon:p.selectedIcon,backgroundId:p.selectedBg};n(Y({boardId:o,body:u})),s()};return e.jsx(y,{onClose:s,title:"Edit board",children:e.jsx(C,{initialValues:{title:r==null?void 0:r.title,selectedIcon:r==null?void 0:r.icon,selectedBg:((a=r==null?void 0:r.background)==null?void 0:a._id)||"null"},validationSchema:$({title:f().max(15,"Must be 15 characters or less").required("Name is required"),selectedIcon:f().required("Icon is required"),selectedBg:f().required("Background is required")}),onSubmit:l,children:e.jsxs(S,{children:[e.jsx(v,{type:"text",name:"title",placeholder:"Title"}),e.jsx(b,{name:"title"}),e.jsx(w,{children:"Icons"}),e.jsx(R,{name:"selectedIcon",selectedItem:r==null?void 0:r.icon}),e.jsx(b,{name:"selectedIcon"}),e.jsx(w,{children:"Backgrounds"}),e.jsx(D,{name:"selectedBg",selectedItem:((i=r==null?void 0:r.background)==null?void 0:i._id)||"null"}),e.jsx(b,{name:"selectedBg"}),e.jsx(I,{type:"submit",children:"Edit"})]})})})},Ye=t.ul`
  width: 100%;
  min-height: 61px;
  margin-bottom: 40px;
...
`,ot=()=>{const[o,s]=c.useState(!1),[r,n]=c.useState(!1),l=m(de),a=m(B),i=j(),p=_(),u=(d,V)=>{i(z(d));const W=V.toLowerCase().replace(/[\s/]+/g,"-");p(W)},h=()=>{s(!0)},g=()=>{s(!1)},k=d=>{n(d),h()},P=d=>{i(Z(d)),p("/home")};return e.jsxs(e.Fragment,{children:[e.jsx(Ye,{children:l.map(d=>d._id===(a==null?void 0:a._id)?e.jsxs(et,{children:[e.jsx(E,{width:"18px",height:"18px",children:e.jsx("use",{href:`${x}#${d.icon}`})}),e.jsx(q,{children:d.title}),e.jsxs(tt,{children:[e.jsx(F,{type:"button",onClick:()=>k(d._id),children:e.jsx(A,{width:"16px",height:"16px",children:e.jsx("use",{href:x+"#icon-pencil"})})}),e.jsx(F,{type:"button",onClick:()=>P(d._id),children:e.jsx(A,{width:"16px",height:"16px",children:e.jsx("use",{href:x+"#icon-trash"})})})]})]},d._id):e.jsxs(Ze,{onClick:()=>{u(d._id,d.title)},children:[e.jsx(E,{width:"18px",height:"18px",children:e.jsx("use",{href:`${x}#${d.icon}`})}),e.jsx(q,{children:d.title})]},d._id))}),o&&e.jsx(Qe,{boardId:r,onClose:g})]})},st=t.p`
  color: var(--primary-text-color);
  font-size: 16px;
  font-weight: 500;
`,rt=t.button`
