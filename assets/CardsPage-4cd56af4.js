import{n as l,u as A,j as i,y as Le,r as w,z as Fe,_ as Te,a as q,A as Be,B as fe,C as Oe,D as Ne,E as je,F as Re,q as ke,H as He}from"./index-e95cb96f.js";import{M as te,B as re,p as De,C as pe,c as Ae,d as ze}from"./selectors-47a17955.js";import{s as L}from"./sprite-685f0d05.js";import{b as ne,c as ae,d as _,e as oe,S as ie,f as E,a as Qe,u as Xe,g as Me,C as K,h as Se}from"./ModalComponents.styled-f102713d.js";const Ge=l.div`
  display: flex;
...
`,ct=l.div``,ut=({columnId:r,onClose:t,columnTitle:e})=>{const n=A(),a=o=>{const s={title:o.title};n(Le({columnId:r,body:s})),t()};return i.jsx(te,{onClose:t,title:"Edit column",children:i.jsx(ne,{initialValues:{title:e},validationSchema:ae({title:_().max(15,"Must be 15 characters or less").required("Name is required")}),onSubmit:a,children:i.jsxs(oe,{children:[i.jsx(ie,{type:"text",name:"title",placeholder:"Title"}),i.jsx(E,{name:"title"}),i.jsx(re,{type:"submit",children:"Edit"})]})})})},ht=l.div`
  position: relative;
  cursor: grab;
  display: flex;
  flex-direction: column;
...
`,Xr=({boardId:r,onClose:t})=>{const e=A(),n=a=>{const o={title:a.title,boardId:r};e(Re(o)),t()};return i.jsx(te,{onClose:t,title:"Add column",children:i.jsx(ne,{initialValues:{title:""},validationSchema:ae({title:_().max(15,"Must be 15 characters or less").required("Name is required")}),onSubmit:n,children:i.jsxs(oe,{children:[i.jsx(ie,{type:"text",name:"title",placeholder:"Title"}),i.jsx(E,{name:"title"}),i.jsx(re,{type:"submit",children:"Add"})]})})})},Gr=()=>{const[r,t]=w.useState(!1),e=q(ke),n=()=>{t(!0)},a=()=>{t(!1)};return i.jsxs(i.Fragment,{children:[i.jsxs(Ar,{onClick:n,type:"button",children:[i.jsx(zr,{children:i.jsx(Qr,{width:"28px",height:"28px",children:i.jsx("use",{href:L+"#icon-plus"})})}),"Add another column"]}),r&&i.jsx(Xr,{boardId:e,onClose:a})]})},Vr=l.button`
  display: flex;
  gap: 8px;
  justify-content: center;
  align-items: center;
...
`,Zr=({onClose:r,columnId:t,boardId:e})=>{const n=A(),a=$e(new Date,"yyyy-MM-dd"),o=s=>{const d={title:s.title,text:s.text,priority:s.selectedPriority,deadline:s.selectedDate,columnId:t,boardId:e};n(He(d)),r()};return i.jsx(te,{onClose:r,title:"Add card",children:i.jsx(ne,{initialValues:{title:"",text:"",selectedPriority:"",selectedDate:a},validationSchema:ae({title:_().max(20,"Must be 20 characters or less").required("Name is required"),text:_().min(5,"Must be 5 characters or more").max(150,"Must be 150 characters or less").required("Description is required"),selectedPriority:_().required("Priority is required"),selectedDate:_().required("Deadline is required")}),onSubmit:o,children:i.jsxs(oe,{children:[i.jsx(ie,{type:"text",name:"title",placeholder:"Title"}),i.jsx(E,{name:"title"}),i.jsx(Me,{as:"textarea",name:"text",placeholder:"Description"}),i.jsx(E,{name:"text"}),i.jsx(K,{children:"Priority color"}),i.jsx(Pe,{name:"selectedPriority"}),i.jsx(E,{name:"selectedPriority"}),i.jsx(K,{children:"Deadline"}),i.jsx(Se,{type:"date",name:"selectedDate"}),i.jsx(E,{name:"selectedDate"}),i.jsx(re,{type:"submit",children:"Add"})]})})})},en=({columnId:r})=>{const[t,e]=w.useState(!1),n=q(ke),a=()=>{e(!0)},o=()=>{e(!1)};return i.jsxs(i.Fragment,{children:[i.jsxs(Vr,{onClick:a,type:"button",children:[i.jsx(Jr,{children:i.jsx(Kr,{width:"28px",height:"28px",children:i.jsx("use",{href:L+"#icon-plus"})})}),"Add another card"]}),t&&i.jsx(Zr,{onClose:o,columnId:r,boardId:n})]})},tn=()=>{const r=q(Ae),t=q(ze),e=q(We),n=q(Ye),[a,o]=w.useState(!1),[s,d]=w.useState(null),[h,c]=w.useState(null),[g,v]=w.useState(null),[x,b]=w.useState(!1),y=w.useRef(null),T=A(),O=()=>{o(!a)},S=m=>{m.stopPropagation(),O()},Y=m=>{m!==n&&(T(Oe(m)),O())},W=(m,p)=>{v(p)},D=m=>{m.preventDefault()},B=(m,p)=>{if(m.preventDefault(),s&&!x){const M=p._id,N="last",Q=s._id;T(fe({cardId:Q,body:{newColumnId:M,newOrderInColumn:N}}))}const I=p.order,P=g.order;if(I!==P){const M={newOrder:I},N=g._id;s||T(je({columnId:N,body:M}))}d(null)};return i.jsxs(Ge,{background:t,children:[i.jsxs(Ve,{children:[i.jsx(Je,{children:r}),i.jsxs(Ke,{children:[i.jsxs(Ze,{ref:y,onClick:S,children:[i.jsx(et,{children:i.jsx("use",{href:L+"#icon-filter"})}),"Filters"]}),a&&i.jsx(pe,{title:"Filter by priority",options:["all priorities",...De],selectedOption:n,isOpen:a,onClose:O,handleOptionClick:Y,openBtnRef:y})]})]}),i.jsx(tt,{children:i.jsxs(rt,{children:[e.map(m=>i.jsxs(nt,{draggable:!0,onDragStart:p=>{W(p,m)},onDragLeave:p=>{},onDragEnd:p=>{},onDragOver:p=>{D(p)},onDrop:p=>{B(p,m)},children:[i.jsx(Hr,{column:m,columns:e,currentCard:s,setCurrentCard:d,currentColumn:h,setCurrentColumn:c,setIsCardOverAnotherCard:b}),i.jsx(en,{columnId:m._id})]},m._id)),i.jsx(Gr,{})]})})]})},rn=l.div`
  width: 100%;
  height: 100%;
  display: flex;
  justify-content: center;
