import{c as x,j as r,B as f,C as v}from"./index-85d86f8a.js";import{n as e}from"./emotion-styled.browser.esm-55173d94.js";import{s as h}from"./sprite-33c0d800.js";import{F as y,a as w,E as k}from"./index.esm-c82d55e5.js";const T=e.div`
  position: absolute;
  top: 20px;
  left: -135px;
  margin: 0;
...
`,ro=e(k)``,to=o=>o.boards.boards,no=o=>o.boards.currentBoard,so=o=>o.boards.currentBoard.background,ao=o=>o.boards.currentBoard.title,io=o=>o.boards.backgrounds,W=e.button`
  display: flex;
  gap: 8px;
  justify-content: center;
  align-items: center;
...
`,U=({children:o,onClick:t,type:s})=>r.jsxs(W,{onClick:t,type:s,children:[r.jsx(N,{children:r.jsx(A,{width:"28px",height:"28px",children:r.jsx("use",{href:h+"#icon-plus"})})}),o]});U.propTypes={children:i.oneOfType([i.string,i.object]).isRequired,onClick:i.func,type:i.string};export{oo as B,K as C,q as M,X as S,D as a,ro as b,U as c,no as d,to as e,Z as f,eo as g,ao as h,Y as i,so as j,Q as p,io as s,J as t};
