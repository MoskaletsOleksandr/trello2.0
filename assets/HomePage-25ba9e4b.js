import{n as o,j as e,r as l,u as v,h as J,d as m,i as K,k as Q,m as Z,o as ee,p as te,q as _,t as U,v as oe,w as se,x as N,y as re,z as ne,O as ie,A as ae,B as ce,C as le}from"./index-32e1df62.js";import{s as h}from"./sprite-cc172135.js";import{M as w,S as y,a as j,b as f,B as I,C as de,t as pe,i as he,s as xe,c as k,d as M,e as ue,f as ge}from"./selectors-e335ac14.js";import{b as B,c as C,d as b,a as R,u as D}from"./index.esm-b547ea7a.js";import{L as me}from"./Logo-0422967a.js";import{I as V,_ as $}from"./index-7bdafccf.js";const fe=o.header`
  display: flex;
  flex-grow: 1;
  height: 60px;
  align-items: center;
...
`,mt=o.svg`
  ...
  transition: stroke 300ms var(--timing-function),
    transform 300ms var(--timing-function);
`,ft=({isOpen:t,toggleSidebar:r})=>{const[s,n]=l.useState(!1),i=()=>{n(!0)},a=()=>{n(!1)};return e.jsxs(e.Fragment,{children:[t&&e.jsx(dt,{onClick:()=>{r()},isOpen:t}),e.jsxs(lt,{isOpen:t,children:[e.jsx(me,{}),e.jsx(pt,{children:"My boards"}),e.jsx(Ke,{}),e.jsx(st,{}),e.jsxs(ht,{children:[e.jsx(xt,{children:"Leave feedback"}),e.jsx(ut,{children:"Share your thoughts to help us. Your feedback on improvements or errors makes this app better!"}),e.jsxs(gt,{onClick:i,children:[e.jsx(mt,{children:e.jsx("use",{href:`${h}#icon-help-circle`})}),"Click me to write"]}),s&&e.jsx(ct,{onClose:a})]}),e.jsx(at,{})]})]})},bt=o.div`
  position: relative;
  display: flex;
  flex-direction: column;
  width: 100vw;
