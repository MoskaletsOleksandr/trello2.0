import{n as e,j as t}from"./index-4278c0ba.js";import{s as r}from"./sprite-fc6f0751.js";const n=e.div`
  display: flex;
  gap: 14px;
  align-items: center;
...
`,l=e.h1`
  ...
  font-weight: 600;
  line-height: normal;
  letter-spacing: ${({large:o})=>o?"-0.03em":"-0.2px"};
`,a=({large:o})=>t.jsxs(n,{large:o,children:[t.jsx(i,{large:o,children:t.jsx(s,{large:o,children:t.jsx("use",{href:r+"#icon-trello"})})}),t.jsx(l,{large:o,children:"Trello2.0"})]});export{a as L};
